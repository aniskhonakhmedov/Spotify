...
let p_name_now = document.querySelector('p[data-name="name"]')

console.log(p_name_now);

// const reload_name_autor_now = (param) =>{
    
// }

// reload_name_autor_now(data)

let listen_now = (param) => {
    console.log(123);
    console.log(param);
}